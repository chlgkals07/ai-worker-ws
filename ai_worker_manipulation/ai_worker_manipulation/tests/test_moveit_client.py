"""
MoveItClient API test — verifies the client initializes correctly,
query methods return valid data, input validation rejects bad inputs,
and the destroy guard prevents use after shutdown.

Does NOT move the arm. Run this first to confirm the client is healthy
before running test_arm_motion.py.
