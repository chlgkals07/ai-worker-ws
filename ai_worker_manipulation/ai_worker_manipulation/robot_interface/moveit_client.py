...
class MoveItClient:
    ...
    def move_to_pose(
        ...
        If local IK (pick-ik mode:local) fails to find a solution, automatically
        retries with LBKPIECE which samples more broadly in the configuration space.
        This handles poses far from the current arm configuration without permanently
        switching to slow global IK.
        """
        self._guard()
